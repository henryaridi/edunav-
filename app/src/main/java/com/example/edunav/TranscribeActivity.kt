...
class TranscribeActivity : ComponentActivity(), TextToSpeech.OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            TranscribeScreen(this, tts, ::startListening)
        }
    }
    ...
    override fun onInit(status: Int) {
        if (status == TextToSpeech.SUCCESS) {
            ...
            speak(
                "Welcome to the Transcribe section. " +
                        "Here, you can record lectures and convert them into text. " +
                        "To begin, say Start Recording. " +
                        "To open Braille section, say Braille. " +
                        "To return home, say Back."
            )
...
@Composable
fun TranscribeScreen(activity: Activity, tts: TextToSpeech, onVoiceCommand: () -> Unit) {
    EduNavTheme {
        AppBackground {
            Column(
                modifier = Modifier
                ...
                Text(
                    "Start Recording to begin transcribing your lecture.",
                    fontSize = 24.sp,
                    color = Color.White
                )
